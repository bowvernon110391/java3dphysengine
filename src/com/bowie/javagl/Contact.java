...
public class Contact {
	public static float MIN_RESTITUTION = 0.04f;		// minimum velocity to bounce off (0.04 m/s)
	public static float RESTITUTION_DISSIPATE = 0.01f;	// 2% dissipated every solver iteration
